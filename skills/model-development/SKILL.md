...
## Four kinds of issue — label which one you are raising
...
Only (3) interrupts development. (4) requires a source. (1) and (2) are logged, not litigated.
...
## Hard vs adaptable
- **Hard rule:** in Develop, derive on the model's own terms and never silently substitute a closure; always surface a genuine mathematical inconsistency, with completions.
