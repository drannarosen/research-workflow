...
- **A signature is not an implementation** → adding the function/class/CLI flag is scaffolding; the claim "implemented" refers to behavior, verified (→ verification-gate).
